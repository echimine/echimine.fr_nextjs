        ...
        <main>
            ...
            <section className="w-full h-screen overflow-hidden flex justify-center">
                ...
                <div className="relative max-w-7xl flex flex-col items-center justify-center gap-6 px-4">
                    <Typographie
                        component="h1"
                        className="title drop-shadow-2xl opacity-80 text-center pt-40"
                        weight="black"
                    >
                        ECHIMINE
                    </Typographie>
            ...
            {/* CHIFFRES */}
            <section className="h-full mx-auto flex flex-col w-full max-w-7xl gap-16 pb-30 md:pt-30">
                ...
                <div
                    className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 sm:p-4 gap-8 justify-items-center pb-30 md:pb-0 px-6">
                    {data.map((data, index) => (
                        <CardData
                            key={index}
                            icon={data.icon}
